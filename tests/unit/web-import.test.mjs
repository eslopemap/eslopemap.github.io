// web-import.js → io.js transitively imports modules that call document.createElement('canvas') at init.
const context = {
  clearRect() {},
  fillRect() {},
...
const { mercatorToLonLat, convertC2cToGpx } = await import('../../app/js/web-import.js');
